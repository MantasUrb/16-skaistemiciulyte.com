...
<html lang="en">
  <head>
    ...
    <title>Addiction To Music | Skaiste Miciulyte</title>
  ...
  <body id="about-body">
    ...
    <div class="container inner-pages-container">
      <div class="row about-hero">
        <div class="title col-12"><p>ADDICTION TO MUSIC</p></div>
        <div class="client col-12"><p>Personal work</p></div>
        <div class="col-12">
          <img src="./img/content/MusicAddiction.webp" alt="Addiction To Music">
        </div>
      </div>
    </div>
