...
<html lang="en">
  <head>
    ...
    <title>Hopes Of The Lockdown Ending | Skaiste Miciulyte</title>
  ...
  <body id="about-body">
    ...
    <div class="container inner-pages-container">
      <div class="row about-hero">
        <div class="title col-12"><p>HOPES OF THE LOCKDOWN ENDING</p></div>
        <div class="client col-12"><p>Personal work</p></div>
        <div class="col-12">
          <img src="./img/content/HopesOfTheLockdownEnding.webp" alt="Hopes Of The Lockdown Ending">
        </div>
      </div>
    </div>
