...
<html lang="en">
  <head>
    ...
    <title>Breaking Out To Freedom | Skaiste Miciulyte</title>
  ...
  <body id="about-body">
    ...
    <div class="container inner-pages-container">
      <div class="row about-hero">
        <div class="title col-12"><p>BREAKING OUT TO FREEDOM</p></div>
        <div class="client col-12"><p>Work for @artistswithbelarus initiative</p></div>
        <div class="col-12">
          <img src="./img/content/BreakingOutToFreedom.webp" alt="Breaking Out To Freedom">
        </div>
      </div>
    </div>
